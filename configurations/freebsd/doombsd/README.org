...
#+begin_src zsh
sudo pkg install btop fastfetch cmatrix cowsay termshark asciiquarium figlet {lol,nyan}cat rgb-tui
#+end_src
...
#+begin_src zsh
sudo pkg install tree eza fzf fd-find ripgrep ripgrep-all cmake markdown markdownfmt zig go uv python lua51 stylua lua51-luarocks rubygem-neovim hs-ShellCheck gnuplot wget grpcurl websocat jq libgraphqlparser tree-{sitter,sitter-{cli,graph,grammars}} shfmt vim neovim py311-{grip,pynvim,sqlfluff,grep-ast} emacs-devel ffmpeg ffmpegthumbnailer coreutils poppler {un,7-}zip aspell aspell-ispell
#+end_src
...
ln -nfs /home/mfarabi/MFarabi619/modules/home/programs/neovim/lazyvim.json /home/mfarabi/.config/nvim/
ln -nfs /home/mfarabi/MFarabi619/configurations/freebsd/.config/nvim/lua/config/* /home/mfarabi/.config/nvim/lua/config/
ln -nfs /home/mfarabi/MFarabi619/configurations/freebsd/.config/nvim/lua/plugins/* /home/mfarabi/.config/nvim/lua/plugins/
#+end_src
...
#+begin_src zsh
sudo pkg install xclip sensors dbus kitty vlc dunst mpv texlive-full firefox webcamd gimp-jxl-plugin mousepad \
