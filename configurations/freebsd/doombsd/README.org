...
#+begin_src sh
unxz FreeBSD-15.0-STABLE-arm64-aarch64-zfs.qcow2.xz
#+end_src
...
qemu-system-aarch64 \
  ...
  -smp 8 \
  -m 32G \
  -drive file=FreeBSD-15.0-STABLE-arm64-aarch64-zfs.qcow2,if=virtio,format=qcow2 \
...
#+begin_src sh
qemu-img resize FreeBSD-15.0-STABLE-arm64-aarch64-zfs.qcow2 256G
qemu-img info FreeBSD-15.0-STABLE-arm64-aarch64-zfs.qcow2
#+end_src
