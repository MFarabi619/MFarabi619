#+title:    :tools platformio
#+subtitle: Platformio support for Emacs
#+created:  February 14, 2026
#+since:    2.0.0

* Description :unfold:
This module adds support for embedded systems development with [[https://platformio.org][PlatformIO]].
