...
// Centralized color registry for terminal output and hardware LEDs.
...
// ─── RGB Packed Colors (for Neopixel) ───────────────────────────────────────
// Usage: neopixel_rgb(RGB_RED)  — expands to neopixel_rgb(255, 0, 0)
