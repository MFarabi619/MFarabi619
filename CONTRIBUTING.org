...
# probe = "303a:1001:1C:DB:D4:40:64:F8"
...
build_flags      =
  ...
  '-DCONFIG_WIFI_CREDENTIALS_STATIC_PASSWORD="${sysenv.WIFI_PSK}"'
  '-DCONFIG_WIFI_CREDENTIALS_STATIC_SSID="${sysenv.WIFI_CREDENTIALS_STATIC_SSID}"'
...
#+begin_src csv :tangle apps/ceratina/machine/esp32s3.partitions.csv
