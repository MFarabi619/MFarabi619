...
2. Remove bloat
  ...
  winget add DesiredStateConfiguration --accept-package-agreements
  #+end_src
...
4. Install programs
  ...
  #+begin_src powershell
  winget add powertoys vivaldi ubuntu "Athena OS" -s msstore --accept-package-agreements
  #+end_src

  [[https://lgug2z.github.io/komorebi/installation.html][Installation - Komorebi]]

  #+begin_src powershell
  winget add vial komorebi whkd wezterm starship docker.desktop qmk.qmktoolbox devcom.jetbrainsmononerdfont
  #+end_src
...
5. Install NixOS-WSL
    ...
    #+begin_src bash
    sudo cp ~/MFarabi619/nixos-unified/configurations/nixos/nixos-wsl/initial-boot.nix /etc/nixos/configuration.nix
    #+end_src
