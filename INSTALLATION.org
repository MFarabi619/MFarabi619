...
#+begin_src ksh
doas pkg_add bash zsh git delta direnv ripgrep eza fd vim-9.1.1706-gtk3 neovim emacs-30.2-pgtk xdg-{user-dirs,dbus-proxy,desktop-portal,utils} libqtxdg consolekit2 ruby34-xdg
#+end_src
