  ...
  config = lib.mkIf cfg.enable {
    ...
    enterShell = lib.mkAfter ''
      ...
      if command -v xtensa-esp-elf-gcc >/dev/null 2>&1; then
        echo -e "\n\033[36m[devenv:embassy]:\033[0m\033[32m Espressif Rust toolchain ready 🦀\033[0m"
      else
        echo -e "\n\033[36m[devenv:embassy]:\033[0m\033[34m xtensa-esp-elf-gcc \033[0m\033[31mtoolchain not found ⚠️\033[0m"
