...
from robot_config.common.definitions.namespace import Namespace
...
class BaseConfig:
    _SERIAL_NUMBER = SerialNumber.parse('generic')
    ...
    def set_serial_number(cls, sn: str) -> None:
        BaseConfig._SERIAL_NUMBER = SerialNumber.parse(sn)
