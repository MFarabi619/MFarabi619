...
fn hardware_params() -> String {
    ...
    format!(
        r#"      <param name="gpio_chip">{chip}</param>
      ...
      <param name="left_pwm_chip">{left_pwm_chip}</param>
      <param name="left_pwm_channel">{left_pwm_channel}</param>
      ...
      <param name="right_pwm_chip">{right_pwm_chip}</param>
      <param name="right_pwm_channel">{right_pwm_channel}</param>
...
"#,
        ...
        left_pwm_chip = wiring::LEFT_PWM_CHIP,
        left_pwm_channel = wiring::LEFT_PWM_CHANNEL,
        left_dir = wiring::LEFT_DIR_PIN,
        left_fwd = i32::from(wiring::LEFT_FORWARD_LEVEL),
        right_pwm_chip = wiring::RIGHT_PWM_CHIP,
        right_pwm_channel = wiring::RIGHT_PWM_CHANNEL,
...
pub fn write(
    ...
    assert_eq!(
        rgpiod_host,
        robot_description::wiring::RGPIOD_HOST,
        "rover.yaml hosts[0].ip and wiring.rs RGPIOD_HOST disagree"
    );
