...
pub const ROBOT_DIMENSIONS: &[(&str, Dimensions)] = &[
    ("robot0", Dimensions { frame_length_mm: 1219.2, frame_width_mm: 1000.0, frame_top_z_mm: 300.0, rear_axle_inset_mm: 85.0, has_deck_equipment: true }),
    ("robot1", Dimensions { frame_length_mm: 750.0, frame_width_mm: 400.0, frame_top_z_mm: 300.0, rear_axle_inset_mm: 135.0, has_deck_equipment: false }),
