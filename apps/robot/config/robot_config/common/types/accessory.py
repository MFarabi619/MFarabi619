...
from robot_config.common.types.exception import UnsupportedAccessoryException
...
class Accessory():
    ...
    def assert_is_supported():
        ...
        robot_config.common.types.exception.UnsupportedAccessoryException
        with a suitable mesage (e.g. 'SpamEggs driver is not yet released for ROS 2 Jazzy')

        @return None

        @exception  Raises a robot_config.common.types.exception.UnsupportedAccessoryException
