...
class CanopyNavigator(Node):
    def __init__(self):
        super().__init__('canopy_navigator')
        ...
        self.action_server = ActionServer(
            ...
            callback_group=self.callback_group)
        self.get_logger().info(f'canopy navigator: {mask_topic} -> {cmd_vel_topic}')
