...
mod tests {
    ...
    async fn user_reads_non_empty_configuration_constants(
        ...
        defmt::assert!(!ceratina::config::app::HOSTNAME.is_empty());
        defmt::assert!(!ceratina::config::board::PLATFORM.is_empty());
        defmt::assert!(!ceratina::config::app::SSH_USER.is_empty());
        defmt::assert!(!ceratina::config::app::NTP_SERVER.is_empty());
        defmt::assert!(!ceratina::config::app::cloudevents::TENANT.is_empty());
        defmt::assert!(!ceratina::config::app::cloudevents::SITE.is_empty());
        defmt::assert!(!ceratina::config::app::cloudevents::SOURCE.is_empty());
        defmt::assert!(!ceratina::config::app::cloudevents::EVENT_TYPE.is_empty());
        Ok(())
    }
    ...
    async fn user_finds_every_service_port_above_zero(
        ...
        defmt::assert!(ceratina::config::app::ssh::PORT > 0);
        defmt::assert!(ceratina::config::app::http::PORT > 0);
        defmt::assert!(ceratina::config::app::ota::PORT > 0);
        defmt::assert!(ceratina::config::app::tcp_log::PORT > 0);
        Ok(())
    }
    ...
    async fn user_finds_buffer_sizes_above_sane_minimums(
        ...
        defmt::assert!(ceratina::config::app::ssh::RX_BUF_SIZE >= 1024);
        defmt::assert!(ceratina::config::app::ssh::TX_BUF_SIZE >= 1024);
        defmt::assert!(ceratina::config::app::ota::RX_BUF_SIZE >= 4096);
        defmt::assert!(ceratina::config::app::ota::CHUNK_SIZE >= 1024);
        Ok(())
    }
    ...
    async fn user_finds_a_plausible_utc_offset(
        ...
        let configured_utc_offset_hours = ceratina::config::app::time::UTC_OFFSET_HOURS;
    ...
    async fn user_formats_epoch_zero_as_empty_string(
        ...
        let formatted = ceratina::time::format_iso8601(0);
    ...
    async fn user_formats_known_epoch_into_iso8601(
        ...
        let formatted = ceratina::time::format_iso8601(1_700_000_000);
    ...
    async fn user_formats_leap_year_date(
        ...
        let formatted = ceratina::time::format_iso8601(1_709_337_600);
    ...
    async fn user_formats_year_2026_epoch(
        ...
        let formatted = ceratina::time::format_iso8601(1_767_225_600);
    ...
    async fn user_reads_zero_epoch_when_time_unsynced(
        ...
        if !ceratina::time::is_time_synced() {
            defmt::assert_eq!(ceratina::time::get_current_epoch_secs(), 0);
        }
        Ok(())
    }
    ...
    async fn user_cannot_upload_file_with_empty_name(
        ...
        defmt::assert!(!ceratina::filesystems::sd::is_supported_flat_file_name(""));
        Ok(())
    }
    ...
    async fn user_cannot_traverse_out_of_upload_directory(
        ...
        use ceratina::filesystems::sd::is_supported_flat_file_name;
    ...
    async fn user_sees_every_sd_error_variant_render_distinctly(
        ...
        use ceratina::filesystems::sd::SdError;
    ...
    async fn user_reaches_http_server_on_port_80(
        ...
        defmt::assert_eq!(ceratina::config::app::http::PORT, 80);
        Ok(())
    }
    ...
    async fn user_sees_device_declares_at_least_one_bus(
        ...
        defmt::assert!(ceratina::config::board::i2c::BUS_0.sda_gpio < 49);
        defmt::assert!(ceratina::config::board::i2c::BUS_1.sda_gpio < 49);
        Ok(())
    }
    ...
    async fn user_sees_every_bus_with_plausible_pins(
        ...
        for (label, sda_gpio_number, scl_gpio_number) in [
            ("i2c.0", ceratina::config::board::i2c::BUS_0.sda_gpio, ceratina::config::board::i2c::BUS_0.scl_gpio),
            ("i2c.1", ceratina::config::board::i2c::BUS_1.sda_gpio, ceratina::config::board::i2c::BUS_1.scl_gpio),
        ] {
    ...
    async fn user_sees_device_name_at_returns_known_names(
        ...
        use ceratina::hardware::i2c::device_name_at;
    ...
    async fn user_sees_shell_home_directory_under_slash_home(
        ...
        let home_directory = ceratina::programs::shell::home_dir();
    ...
    async fn user_sees_tilde_when_cwd_is_home(
        ...
        let home_directory = ceratina::programs::shell::home_dir();
        let displayed_cwd = ceratina::programs::shell::display_cwd(home_directory.as_str());
    ...
    async fn user_sees_tilde_subdir_when_cwd_is_below_home(
        ...
        let displayed_cwd =
            ceratina::programs::shell::display_cwd(subdirectory_under_home.as_str());
    ...
    async fn user_sees_slash_when_cwd_is_root(
        ...
        let displayed_cwd = ceratina::programs::shell::display_cwd("/");
        defmt::assert_eq!(displayed_cwd.as_str(), "/");
        Ok(())
    }
    ...
    async fn user_sees_literal_path_for_unrelated_cwd(
        ...
        let displayed_cwd = ceratina::programs::shell::display_cwd("/etc");
    ...
    async fn user_runs_cd_tilde_to_return_home(
        ...
        ceratina::programs::shell::apply_cd(&mut current_working_directory, "~");
        let home_directory = ceratina::programs::shell::home_dir();
    ...
    async fn user_runs_cd_with_absolute_path(
        ...
        ceratina::programs::shell::apply_cd(&mut current_working_directory, "/etc");
    ...
    async fn user_runs_cd_with_relative_path(
        ...
        ceratina::programs::shell::apply_cd(&mut current_working_directory, "user");
        defmt::assert_eq!(current_working_directory.as_str(), "/home/user");
        Ok(())
    }
    ...
    async fn user_runs_cd_tilde_subdir(
        ...
        use alloc::string::String;
        let mut current_working_directory = String::from("/etc");
        ceratina::programs::shell::apply_cd(&mut current_working_directory, "~/documents");
        let home_directory = ceratina::programs::shell::home_dir();
    ...
    async fn user_resolves_relative_filename_against_cwd(
        ...
        let resolved_path =
            ceratina::programs::shell::resolve_path("/home/user", "file.txt");
    ...
    async fn user_resolves_absolute_path_verbatim(
        ...
        let resolved_path =
            ceratina::programs::shell::resolve_path("/home/user", "/etc/rc.conf");
    ...
    async fn user_resolves_relative_filename_from_root(
        ...
        let resolved_path = ceratina::programs::shell::resolve_path("/", "data.csv");
    ...
    async fn user_runs_exit_and_shell_signals_exit(
        ...
        let (output, should_exit) =
            ceratina::programs::shell::dispatch("exit", &mut current_working_directory);
    ...
    async fn user_runs_quit_and_shell_signals_exit(
        ...
        let (_unused_output, should_exit) =
            ceratina::programs::shell::dispatch("quit", &mut current_working_directory);
        defmt::assert!(should_exit);
        Ok(())
    }
    ...
    async fn user_runs_unknown_command_and_gets_error(
        ...
        use alloc::string::String;
        let mut current_working_directory = String::from("/");
        let (output, should_exit) = ceratina::programs::shell::dispatch(
            "nonexistent_cmd",
    ...
    async fn user_submits_empty_line_and_shell_stays_quiet(
        ...
        let mut current_working_directory = String::from("/");
        let (output, should_exit) =
            ceratina::programs::shell::dispatch("", &mut current_working_directory);
        defmt::assert!(!should_exit);
        defmt::assert!(output.is_empty());
        Ok(())
    }
    ...
    async fn user_runs_help_and_gets_help_message(
        ...
        let mut current_working_directory = String::from("/");
        let (output, should_exit) =
            ceratina::programs::shell::dispatch("help", &mut current_working_directory);
        defmt::assert!(!should_exit);
        defmt::assert!(!output.is_empty());
        Ok(())
    }
    ...
    async fn user_runs_pwd_and_sees_current_directory(
        ...
        let (output, _should_exit) =
            ceratina::programs::shell::dispatch("pwd", &mut current_working_directory);
    ...
    async fn user_runs_hostname_and_gets_hostname(
        ...
        let mut current_working_directory = String::from("/");
        let (output, _should_exit) =
            ceratina::programs::shell::dispatch("hostname", &mut current_working_directory);
        defmt::assert!(!output.is_empty());
        Ok(())
    }
    ...
    async fn user_runs_whoami_and_gets_username(
        ...
        let mut current_working_directory = String::from("/");
        let (output, _should_exit) =
            ceratina::programs::shell::dispatch("whoami", &mut current_working_directory);
        defmt::assert!(!output.is_empty());
        Ok(())
    }
    ...
    async fn user_runs_uptime_and_sees_runtime(
        ...
        let mut current_working_directory = String::from("/");
        let (output, _should_exit) =
            ceratina::programs::shell::dispatch("uptime", &mut current_working_directory);
        defmt::assert!(!output.is_empty());
        Ok(())
    }
    ...
    async fn user_runs_free_and_sees_heap_report(
        ...
        let mut current_working_directory = String::from("/");
        let (output, _should_exit) =
            ceratina::programs::shell::dispatch("free", &mut current_working_directory);
        defmt::assert!(!output.is_empty());
    ...
    async fn user_runs_date_and_sees_timestamp(
        ...
        let mut current_working_directory = String::from("/");
        let (output, _should_exit) =
            ceratina::programs::shell::dispatch("date", &mut current_working_directory);
        defmt::assert!(!output.is_empty());
        Ok(())
    }
    ...
    async fn user_sees_sd_card_reports_its_size(
        ...
        let snapshot = ceratina::filesystems::sd::snapshot();
    ...
    async fn user_verifies_root_directory_exists(
        ...
        defmt::assert!(ceratina::filesystems::sd::directory_exists("/"));
        Ok(())
    }
    ...
    async fn user_runs_ls_and_sees_directory_listing(
        ...
        let (output, _) = ceratina::programs::shell::dispatch("ls", &mut cwd);
        defmt::assert!(!output.is_empty());
        Ok(())
    }
    ...
    async fn user_runs_df_and_sees_disk_usage(
        ...
        use alloc::string::String;
        let mut cwd = String::from("/");
        let (output, _) = ceratina::programs::shell::dispatch("df", &mut cwd);
        defmt::assert!(!output.is_empty());
        Ok(())
    }
    ...
    async fn user_runs_sensors_and_sees_status(
        ...
        use alloc::string::String;
        let mut cwd = String::from("/");
        let (output, _) = ceratina::programs::shell::dispatch("sensors", &mut cwd);
        defmt::assert!(!output.is_empty());
        Ok(())
    }
    ...
    async fn user_runs_ifconfig_and_sees_network_info(
        ...
        use alloc::string::String;
        let mut cwd = String::from("/");
        let (output, _) = ceratina::programs::shell::dispatch("ifconfig", &mut cwd);
        defmt::assert!(!output.is_empty());
        Ok(())
    }
    ...
    async fn user_runs_wakecause_and_sees_wake_source(
        ...
        use alloc::string::String;
        let mut cwd = String::from("/");
        let (output, _) = ceratina::programs::shell::dispatch("wakecause", &mut cwd);
        defmt::assert!(!output.is_empty());
        Ok(())
    }
    ...
    async fn user_runs_logstatus_and_sees_logger_state(
        ...
        use alloc::string::String;
        let mut cwd = String::from("/");
        let (output, _) = ceratina::programs::shell::dispatch("logstatus", &mut cwd);
        defmt::assert!(!output.is_empty());
        Ok(())
    }
    ...
    async fn user_runs_cat_on_nonexistent_file(
        ...
        let mut cwd = String::from("/");
        let (output, should_exit) =
            ceratina::programs::shell::dispatch("cat nonexistent_xyz.txt", &mut cwd);
        defmt::assert!(!should_exit);
        defmt::assert!(!output.is_empty());
        Ok(())
    }
    ...
    async fn user_runs_clear_and_gets_ansi_escape(
        ...
        use alloc::string::String;
        let mut cwd = String::from("/");
        let (output, _) = ceratina::programs::shell::dispatch("clear", &mut cwd);
    ...
    async fn user_runs_microfetch_and_sees_system_info(
        ...
        use alloc::string::String;
        let mut cwd = String::from("/");
        let (output, _) = ceratina::programs::shell::dispatch("microfetch", &mut cwd);
        defmt::assert!(!output.is_empty());
        defmt::assert!(output.contains(ceratina::config::app::HOSTNAME));
        Ok(())
    }
    ...
    async fn user_runs_touch_then_rm_on_sd(
        ...
        let (touch_output, _) =
            ceratina::programs::shell::dispatch("touch test_rm.txt", &mut cwd);
        defmt::assert!(!touch_output.contains("error"), "touch should succeed");

        let (rm_output, _) =
            ceratina::programs::shell::dispatch("rm test_rm.txt", &mut cwd);
