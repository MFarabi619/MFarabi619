...
fn draw_text(frame: &mut Frame, area: Rect) {
    ...
    let text = vec![
        ...
        Line::from(""),
        Line::from(" [x] Create something, anything"),
        Line::from(" [x] Deploy to Netlify"),
        Line::from(" [x] Make responsive"),
        Line::from(" [x] Self-host from home data center with Kubernetes and/or Kubenix"),
